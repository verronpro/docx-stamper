...
public class SectionUtil {
     ...
     */
    public static SectPr getPreviousSectionBreakIfPresent(
            Object firstObject,
        ...
        log.info(
                "No previous section break found from : {}, first object index={}",
                parent,
                pIndex);
        return null;
    }
    ...
    public static boolean isOddNumberOfSectionBreaks(List<Object> objects) {
        long count = objects.stream()
                ...
                .map(P.class::cast)
                .filter(p -> p.getPPr() != null && p.getPPr()
                                                           .getSectPr() != null)
                .count();
        return count % 2 != 0;
    }
     ...
     */
    public static void applySectionBreakToParagraph(
            SectPr sectPr,
            P paragraph
    ) {
