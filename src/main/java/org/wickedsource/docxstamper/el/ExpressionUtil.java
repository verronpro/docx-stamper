...
public class ExpressionUtil {
    private static final Pattern VARIABLE_PATTERN = compile("\\$\\{(.*?)}");
    private static final Pattern PROCESSOR_PATTERN = compile("#\\{(.*?)}");
    ...
    public static List<String> findVariableExpressions(@NonNull String text) {
        return findExpressions(text, VARIABLE_PATTERN);
    }

    private static List<String> findExpressions(
            @NonNull String text, Pattern pattern
    ) {
    ...
    public static List<String> findProcessorExpressions(@NonNull String text) {
        return findExpressions(text, PROCESSOR_PATTERN);
    }
}
